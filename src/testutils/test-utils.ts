...
export const podcastTestData: Podcast[] = [
  {
    ...
    "im:contentType": {
      attributes: { term: FluffyLabel.Podcast, label: FluffyLabel.Podcast },
    },
    ...
    "im:releaseDate": {
      label: new Date("2023-09-27T00:00:00-07:00"),
      attributes: { label: "September 27, 2023" },
    },
  },
];
